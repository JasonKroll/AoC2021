...
namespace AoC2021.Tests
{
    public class Tests
    {
        ...
        public void Day11a()
        {
            var res = _Runner.Answer1(typeof(Day11));
            Assert.That(res, Is.EqualTo(1656));
        }

        [Test]
        public void Day11b()
        {
            var res = _Runner.Answer2(typeof(Day11));
            Assert.That(res, Is.EqualTo(195));
        }

        [Test]
        public void Day12a()
        {
            var res = _Runner.Answer1(typeof(Day12));
            Assert.That(res, Is.EqualTo(226));
        }

        [Test]
        public void Day12b()
        {
            var res = _Runner.Answer2(typeof(Day12));
            Assert.That(res, Is.EqualTo(3509));
        }

        [Test]
        public void Day13a()
        {
            var res = _Runner.Answer1(typeof(Day13));
        ...
        public void Day13b()
        {
            var res = _Runner.Answer2(typeof(Day13));
        ...
        public void Day14a()
        {
            var res = _Runner.Answer1(typeof(Day14));
            Assert.That(res, Is.EqualTo(1588));
        }

        [Test]
        public void Day14b()
        {
            var res = _Runner.Answer2(typeof(Day14));
            Assert.That(res, Is.EqualTo(2188189693529));
        }

        [Test]
        public void Day15a()
        {
            var res = _Runner.Answer1(typeof(Day15));
        ...
        public void Day15b()
        {
            var res = _Runner.Answer2(typeof(Day15));
            Assert.That(res, Is.EqualTo(315));
        }
